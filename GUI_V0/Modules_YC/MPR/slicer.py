...
actor_axial.SetInputConnection(color_axial.GetOutputPort())
...
actor_coronal.SetInputConnection(color_coronal.GetOutputPort())
...
actor_sagittal.SetInputConnection(color_sagittal.GetOutputPort())
...
actor_oblique.SetInputConnection(color_oblique.GetOutputPort())
