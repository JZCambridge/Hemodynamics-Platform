...
def WriteDic(Outpath=None, branchLst=None):
    ...
    coronaryArtery = [
        ...
        },
        {
            ...
            "use": True,
            "parent_exist": False,
            "original_csv": "pmLAD.csv",
            "3D_csv": "pmLAD3D.csv",
            "original_branch": "pmLAD_OriB_",
            "cross_section_image_NN": "pmLADCTANN.nii.gz",
            "cross_section_mask_NN": "pmLADValNN.nii.gz",
            "cross_section_mask_fix": "pmLADValNNFixVal.nii.gz",
            "cross_section_mask_fix_extension": "pmLADValNNFE.nii.gz",
            "original_volume_mask_fix": "pmLADValNNFEOV.nii.gz",
            "cross_section_image_LI": "pmLADCTALI.nii.gz",
            "cross_section_mask_LI": "pmLADValLI.nii.gz"
        },
        {
            "branch_name": "D1",
            "label": [9],
        ...
        },
        {
            ...
            "use": True,
            "parent_exist": False,
            "original_csv": "pmCx.csv",
            "3D_csv": "pmCx3D.csv",
            "original_branch": "pmCx_OriB_",
            "cross_section_image_NN": "pmCxCTANN.nii.gz",
            "cross_section_mask_NN": "pmCxValNN.nii.gz",
            "cross_section_mask_fix": "pmCxValNNFixVal.nii.gz",
            "cross_section_mask_fix_extension": "pmCxValNNFE.nii.gz",
            "original_volume_mask_fix": "pmCxValNNFEOV.nii.gz",
            "cross_section_image_LI": "pmCxCTALI.nii.gz",
            "cross_section_mask_LI": "pmCxValLI.nii.gz"
        },
        {
            "branch_name": "OM1",
            "label": [12],
        ...
        },
        {
            ...
            "use": True,
            "parent_exist": None,
            "original_csv": "pmRCA.csv",
            "3D_csv": "pmRCA3D.csv",
            "original_branch": "pmRCA_OriB_",
            "cross_section_image_NN": "pmRCACTANN.nii.gz",
            "cross_section_mask_NN": "pmRCAValNN.nii.gz",
            "cross_section_mask_fix": "pmRCAValNNFixVal.nii.gz",
            "cross_section_mask_fix_extension": "pmRCAValNNFE.nii.gz",
            "original_volume_mask_fix": "pmRCAValNNFEOV.nii.gz",
            "cross_section_image_LI": "pmRCACTALI.nii.gz",
            "cross_section_mask_LI": "pmRCAValLI.nii.gz"
        },
        {
            "branch_name": "dRCA",
            "label": [3],
            ...
            if dict["branch_name"] in barnchName:
                ...
                if (not dict["coordinates"]) and (dict["branch_name"] not in ignoreCoordsLst):  # empty coordinate list and not in ignore coordinate list
                    ...
                    if len(coronaryDictionaries[index]["branch_label"]) == 1\
                        or coronaryDictionaries[index]["branch_name"] == "pmRCA"\
                        or coronaryDictionaries[index]["branch_name"] == "pmLAD"\
                        or coronaryDictionaries[index]["branch_name"] == "pmCx":
